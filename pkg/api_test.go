	...
	tests := []struct {
		...
		},
		{
			...
			Lead: model.Lead{
				...
				Observations: &observations,
				Microsoft: model.Microsoft{
					Anosordenadoresmedia:        &t1,
					SistemaOperativoInstalado:   &t2,
					FrecuenciaBloqueOrdenadores: &t3,
					NumeroDispositivosEmpresa:   &t4,
					ReparacionesUltimoAno:       &t5,
					TiempoArrancarDispositivos:  &t6,
				},
			},
			ExpectedResult: model.LeadLeontel{
				LeaSource:      61,
